...
const OrderScreen = () => {
  ...
  }, [dispatch, order, orderId, history, customerInfo, success, successCoupon]);
        ...
        <Col md={9}>
          ...
          {order &&
            ...
            customerInfo.email === order.customer.email && (
              <LinkContainer to={`/confirmreturn/${order._id}`}>
                <Button variant='primary'>Return</Button>
              </LinkContainer>
            )}
        </Col>
        <Col md={3}>
          ...
          {order && (
            <LinkContainer to={`/invoice/${order._id}`}>
              <Button className='btn btn-block'>Go to Invoice</Button>
            </LinkContainer>
          )}
          ...
          <Col md={6}>
            ...
            <Row style={{ marginTop: "10px" }}>
              ...
              <Col md={6}>
                ...
                {order && Number(order.extraPrice) > 0 && (
                  <LinkContainer to={`/device/${order._id}`}>
                    <Button className='btn btn-block'>
                      Go to Device Protection Card
                    </Button>

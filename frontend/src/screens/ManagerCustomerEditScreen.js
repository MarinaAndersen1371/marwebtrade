...
const ManagerCustomerEditScreen = () => {
  ...
  return (
    <>
      ...
      <Link to={"/manager/customerlist"} className='btn btn-light '>
        Go to Customer List
      </Link>
      <Link to={"/manager/primelist"} className='btn btn-light ml-3'>
        Go to Premium Member List
      </Link>
      <Link to={"/manager/franchiselist"} className='btn btn-light ml-3'>
      ...
      {loading ? (
        ...
        <ListGroup>
          <Row>
            <Col md={6}>
              <h1 style={{ marginTop: "120px", marginBottom: "90px" }}>
            ...
            <Col md={6}>
              <Row style={{ marginTop: "150px", marginBottom: "70px" }}>
                <Col md={5}>
                  <h6>Name:</h6>
                  <h6>Customer ID:</h6>
                </Col>
                <Col md={7}>
                  <h6>
                    {customer && customer.firstName} {customer && customer.name}
                  </h6>
                  <h6>{customer && customer._id}</h6>
                </Col>
              </Row>
              <ListGroup.Item>

...
const ManagerOrderEditScreen = () => {
  ...
  return (
    <>
      ...
      <Link to={"/manager/orderlist"} className='btn btn-light  ml-3'>
        Order List
      </Link>
      <Link to={"/manager/invoicelist"} className='btn btn-light ml-3'>
        Invoice List
      </Link>
      <Link to={"/manager/deliverylist"} className='btn btn-light ml-3'>
        Delivery Note List
      </Link>
      <Link to={"/manager/devicelist"} className='btn btn-light ml-3'>
        Device Protection List
      </Link>
      <Link to={"/manager/voucherlist"} className='btn btn-light ml-3'>
        Voucher List
      </Link>
      <Link to={"/manager/returnlist"} className='btn btn-light  ml-3'>
        Order Return List
      </Link>
      ...
      {loading ? (
        ...
        <ListGroup>
          <Row>
            <Col md={6}>
              <h1 style={{ marginTop: "90px", marginBottom: "120px" }}>
                Update Order Status
              </h1>
              <ListGroup.Item>
            ...
            <Col md={6}>
              <ListGroup.Item
                style={{ marginTop: "110px", marginBottom: "45px" }}
              >
                <Row>
                  <Col md={5}>
                    <h5>Order ID:</h5>
